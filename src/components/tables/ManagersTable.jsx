...
function ManagersTable() {
  return (
    <div className='overflow-scroll p-8 flex mt-[20px] bg-slate-300'>
         ...
         managers.map(manager => {
           return(
             <tr key={manager.username} className=' table-row hover:bg-gray-200'>
               ...
               <img className=' person-img w-[50px] h-[50px] m-auto rounded-lg' src={manager.img} alt='sawir' onClick={zoomImage} />
               </td>
